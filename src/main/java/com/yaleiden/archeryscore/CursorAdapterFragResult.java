...
public class CursorAdapterFragResult extends SimpleCursorAdapter {

    private ScoreArrays resultScoreArray = new ScoreArrays();
    private int[] userResultArray;
    RelativeLayout.LayoutParams params;
    Context context;
    Cursor c;

    public CursorAdapterFragResult(Context context, int layout, Cursor c,
                                   String[] from, int[] to) {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        TextView totalView = (TextView) view.findViewById(R.id.textViewResult2);
        //TextView courseView = (TextView) view				.findViewById(R.id.textViewResult4);
        String TAG = "CursorAdapterFragResult";
        ...
        String NumTargets = "0";
        if (eight != null && !eight.isEmpty()) {
            NumTargets = cursor.getString(8).trim(); // SET
        }
       ...
       // }
        ...
        int currentTotal = 0;
        for (int b = 0; b < totalTargets; b++) {
            currentTotal = currentTotal + allUserScores[b];
        }
        double totPoss = totalTargets * Double.valueOf(maxUserScore);
        double percentage = 100 * currentTotal / totPoss;
        double averagePerArrow = (double) currentTotal / totalTargets;
        ...
        String pct = String.format("%.2f", percentage);
        String avg = String.format("%.2f", averagePerArrow);
        textViewB1.setText(context.getString(R.string.thru) + " " + cursor.getString(8));
        textViewB2.setText(pct + "%");
        textViewB3.setText(avg);
    ...
    private void setBullProgressGreen(int numScore){
